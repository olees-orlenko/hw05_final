...
class PostViewTests(TestCase):
    ...
    def test_index_uses_correct_context(self):
        ...
        response = self.guest_client.get(INDEX_REVERSE)
    ...
    def test_post_added_to_correct_pages(self):
        ...
        form_fields = {
            INDEX_REVERSE: Post.objects.get(group=self.post.group),
            reverse(
    ...
    def test_cache_index(self):
        ...
        response2 = self.guest_client.get(INDEX_REVERSE)
        response_2 = response2.content
        self.assertEqual(response_1, response_2)

    def test_follow_page(self):
        """Проверка подписки и отписки на автора"""
        response = self.authorized_client.get(POST_FOLLOW_REVERSE)
